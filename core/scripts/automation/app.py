...
if df_1 is not None:
    if selected_month == "All":
        ...
        filtered_df_1 = df_1[df_1["Month"] == selected_month]

    # Calculate energy consumption for proposed data (filtered)
    energy_consumption_1 = calculate_energy_consumption(
        filtered_df_1, 'proposed')
...
if df_2 is not None:
    ...
    energy_consumption_2 = calculate_energy_consumption(
        filtered_df_2, 'comparison')
...
if uploaded_file_1 is not None and uploaded_file_2 is not None:
    ...
    for proposed_value, compare_value in zip(energy_consumption_1.values(), energy_consumption_2.values()):
        ...
        reduction = abs(
            ((proposed_value - compare_value) / proposed_value) * 100)
...
def calculate_ghg_emissions(energy_consumption):
    ...
    ghg_emission_kgCO2e = (total_energy_kWh * 3412/1000000) * \
        emission_factor  # Convert to kgCO2e
    ...
    hvac_ghg_emission_kgCO2e = hvac_energy_kWh * \
        emission_factor / 1000  # Convert to kgCO2e
